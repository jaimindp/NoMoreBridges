export const oldEndpointsMainnetK8s = {
...
export const oldEndpointsMainnetLB = {
    indexerApi: 'https://k8s.mainnet.exchange.grpc-web.injective.network',
    sentryGrpcApi: 'https://k8s.mainnet.chain.grpc-web.injective.network',
    tendermintApi: 'https://k8s.mainnet.tm.injective.network',
    sentryHttpApi: 'https://k8s.mainnet.lcd.injective.network',
};
export const oldEndpointsMainnet = {
...
export const oldEndpointsStaging = {
...
export const oldEndpointsPublic = {
...
export const oldEndpointsTestnetK8s = {
...
export const oldEndpointsTestnetOld = {
...
export const oldEndpointsTestnet = {
    ...oldEndpointsTestnetK8s,
};
export const oldEndpointsDevnet = {
...
export const oldEndpointsDevnet1 = {
...
export const oldEndpointsDevnet2 = {
...
export const oldEndpointsLocal = {
