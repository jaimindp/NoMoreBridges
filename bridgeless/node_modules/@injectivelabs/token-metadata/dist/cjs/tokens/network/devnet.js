...
exports.getTokensBySymbolForDevnet2 = exports.getTokensBySymbolForDevnet1 = exports.getTokensBySymbolForDevnet = void 0;
...
const getTokensBySymbolForDevnet = () => Object.keys(tokens_1.default).reduce((result, symbol) => {
    ...
    const tokenMeta = (0, tokens_1.devnetTokens)()[symbol] || tokens_1.default[symbol];
