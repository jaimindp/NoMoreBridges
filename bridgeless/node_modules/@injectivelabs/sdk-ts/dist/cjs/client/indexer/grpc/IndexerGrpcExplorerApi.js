...
class IndexerGrpcExplorerApi {
    ...
    fetchAccountTx({ address, limit, type, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetAccountTxs(request);
    ...
    fetchValidator(validatorAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetValidator(request);
    ...
    fetchValidatorUptime(validatorAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.address = validatorAddress;
            try {
                const response = yield this.client.GetValidatorUptime(request);
    ...
    fetchPeggyDepositTxs({ sender, receiver, limit, skip, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetPeggyDepositTxs(request);
    ...
    fetchPeggyWithdrawalTxs({ sender, receiver, limit, skip, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetPeggyWithdrawalTxs(request);
    ...
    fetchBlocks({ before, after, limit, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetBlocks(request);
                return response;
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveExplorerRpc.GrpcWebError) {
    ...
    fetchBlock(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.id = id;
            try {
                const response = yield this.client.GetBlock(request);
                return response;
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveExplorerRpc.GrpcWebError) {
    ...
    fetchTxs({ before, after, limit, skip, type, module, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetTxs(request);
                return response;
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveExplorerRpc.GrpcWebError) {
    ...
    fetchIBCTransferTxs({ sender, receiver, srcChannel, srcPort, destChannel, destPort, limit, skip, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.GetIBCTransferTxs(request);
