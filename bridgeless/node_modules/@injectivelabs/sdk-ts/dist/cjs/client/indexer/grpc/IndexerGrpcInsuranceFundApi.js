...
class IndexerGrpcInsuranceFundApi {
    constructor(endpoint) {
        ...
        this.client = new indexer_proto_ts_1.InjectiveInsuranceRpc.InjectiveInsuranceRPCClientImpl((0, BaseIndexerGrpcWebConsumer_1.getGrpcIndexerWebImpl)(endpoint));
    }
    fetchRedemptions({ denom, address, status, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Redemptions(request);
    ...
    fetchInsuranceFunds() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Funds(request);
