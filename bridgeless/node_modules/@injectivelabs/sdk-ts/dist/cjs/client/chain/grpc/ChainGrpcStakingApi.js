...
class ChainGrpcStakingApi {
    constructor(endpoint) {
        ...
        this.client = new core_proto_ts_1.CosmosStakingV1Beta1Query.QueryClientImpl((0, BaseGrpcWebConsumer_1.getGrpcWebImpl)(endpoint));
    }
    fetchModuleParams() {
    ...
    fetchPool() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Pool(request);
    ...
    fetchValidators(pagination) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Validators(request);
    ...
    fetchValidator(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Validator(request);
    ...
    fetchValidatorDelegations({ validatorAddress, pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.ValidatorDelegations(request);
    ...
    fetchValidatorUnbondingDelegations({ validatorAddress, pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.ValidatorUnbondingDelegations(request);
    ...
    fetchDelegation({ injectiveAddress, validatorAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.validatorAddr = validatorAddress;
            try {
                const response = yield this.client.Delegation(request);
    ...
    fetchDelegations({ injectiveAddress, pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.DelegatorDelegations(request);
                return transformers_1.ChainGrpcStakingTransformer.delegationsResponseToDelegations(response);
            }
            catch (e) {
                if (e instanceof core_proto_ts_1.CosmosStakingV1Beta1Query.GrpcWebError) {
    ...
    fetchUnbondingDelegations({ injectiveAddress, pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.DelegatorUnbondingDelegations(request);
                return transformers_1.ChainGrpcStakingTransformer.unBondingDelegationsResponseToUnBondingDelegations(response);
            }
            catch (e) {
                if (e instanceof core_proto_ts_1.CosmosStakingV1Beta1Query.GrpcWebError) {
    ...
    fetchReDelegations({ injectiveAddress, pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Redelegations(request);
