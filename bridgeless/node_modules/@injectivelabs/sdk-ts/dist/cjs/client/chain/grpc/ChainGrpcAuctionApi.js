...
class ChainGrpcAuctionApi {
    constructor(endpoint) {
        ...
        this.client = new core_proto_ts_1.InjectiveAuctionV1Beta1Query.QueryClientImpl((0, BaseGrpcWebConsumer_1.getGrpcWebImpl)(endpoint));
    }
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            const request = core_proto_ts_1.InjectiveAuctionV1Beta1Query.QueryAuctionParamsRequest.create();
            try {
                const response = yield this.client.AuctionParams(request);
    ...
    fetchModuleState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.AuctionModuleState(request);
    ...
    fetchCurrentBasket() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.CurrentAuctionBasket(request);
