 ...
 */
class ChainGrpcMintApi {
    constructor(endpoint) {
        this.module = types_1.ChainModule.Mint;
        this.client = new core_proto_ts_1.CosmosMintV1Beta1Query.QueryClientImpl((0, BaseGrpcWebConsumer_1.getGrpcWebImpl)(endpoint));
    }
    fetchModuleParams() {
    ...
    fetchInflation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Inflation(request);
                return {
    ...
    fetchAnnualProvisions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.AnnualProvisions(request);
                return {
