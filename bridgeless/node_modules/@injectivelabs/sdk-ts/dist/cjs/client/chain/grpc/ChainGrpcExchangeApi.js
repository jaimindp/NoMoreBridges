...
class ChainGrpcExchangeApi {
    constructor(endpoint) {
        ...
        this.client = new core_proto_ts_1.InjectiveExchangeV1Beta1Query.QueryClientImpl((0, BaseGrpcWebConsumer_1.getGrpcWebImpl)(endpoint));
    }
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            const request = core_proto_ts_1.InjectiveExchangeV1Beta1Query.QueryExchangeParamsRequest.create();
            try {
                const response = yield this.client.QueryExchangeParams(request);
    ...
    fetchModuleState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.ExchangeModuleState(request);
    ...
    fetchFeeDiscountSchedule() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.FeeDiscountSchedule(request);
    ...
    fetchFeeDiscountAccountInfo(injectiveAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.FeeDiscountAccountInfo(request);
    ...
    fetchTradingRewardsCampaign() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.TradeRewardCampaign(request);
    ...
    fetchTradeRewardPoints(injectiveAddresses) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.TradeRewardPoints(request);
    ...
    fetchPendingTradeRewardPoints(injectiveAddresses, timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.PendingTradeRewardPoints(request);
                return response.accountTradeRewardPoints;
            }
            catch (e) {
                if (e instanceof core_proto_ts_1.InjectiveExchangeV1Beta1Query.GrpcWebError) {
    ...
    fetchSubaccountTradeNonce(subaccountId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.SubaccountTradeNonce(request);
                return response;
            }
            catch (e) {
                if (e instanceof core_proto_ts_1.InjectiveExchangeV1Beta1Query.GrpcWebError) {
