...
class PublicKey {
    ...
    toAddress() {
        ...
        const decompressedPublicKey = eth_crypto_1.publicKey.decompress(publicKeyHex);
        const addressBuffer = Buffer.from((0, js_sha3_1.keccak256)((0, ethereumjs_util_1.toBuffer)(eth_crypto_1.util.addLeading0x(decompressedPublicKey))), 'hex').subarray(-20);
