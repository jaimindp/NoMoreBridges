...
class MsgSubmitProposalPerpetualMarketLaunch extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        contentAny.value =
            core_proto_ts_1.InjectiveExchangeV1Beta1Tx.PerpetualMarketLaunchProposal.encode(content).finish();
    ...
    toAmino() {
        ...
        const messageWithProposalType = Object.assign(Object.assign({}, message), { content: {
    ...
    toWeb3() {
        ...
        const messageWithProposalType = (0, snakecase_keys_1.default)(Object.assign(Object.assign({}, message), { content: Object.assign(Object.assign({}, message.content), { '@type': proposalType }) }));
    ...
    getContent() {
        const { params } = this;
        const content = core_proto_ts_1.InjectiveExchangeV1Beta1Tx.PerpetualMarketLaunchProposal.create();
        ...
        return core_proto_ts_1.InjectiveExchangeV1Beta1Tx.PerpetualMarketLaunchProposal.fromPartial(content);
    }
}
