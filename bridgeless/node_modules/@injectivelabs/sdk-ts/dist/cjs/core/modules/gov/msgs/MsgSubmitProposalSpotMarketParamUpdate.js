...
class MsgSubmitProposalSpotMarketParamUpdate extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        contentAny.value =
            core_proto_ts_1.InjectiveExchangeV1Beta1Tx.SpotMarketParamUpdateProposal.encode(content).finish();
    ...
    getContent() {
        const { params } = this;
        const content = core_proto_ts_1.InjectiveExchangeV1Beta1Tx.SpotMarketParamUpdateProposal.create();
        ...
        return core_proto_ts_1.InjectiveExchangeV1Beta1Tx.SpotMarketParamUpdateProposal.fromPartial(content);
    }
}
