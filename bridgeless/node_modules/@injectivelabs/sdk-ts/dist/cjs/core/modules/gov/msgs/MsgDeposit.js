...
class MsgDeposit extends MsgBase_1.MsgBase {
    ...
    toProto() {
        ...
        const message = core_proto_ts_1.CosmosGovV1Beta1Tx.MsgDeposit.create();
        message.depositor = params.depositor;
        message.proposalId = params.proposalId.toString();
        message.amount = [deposit];
        return core_proto_ts_1.CosmosGovV1Beta1Tx.MsgDeposit.fromPartial(message);
    }
    toData() {
    ...
    toBinary() {
        return core_proto_ts_1.CosmosGovV1Beta1Tx.MsgDeposit.encode(this.toProto()).finish();
    }
}
