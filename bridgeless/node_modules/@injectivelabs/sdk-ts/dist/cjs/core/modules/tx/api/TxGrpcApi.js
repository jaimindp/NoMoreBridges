...
const BaseGrpcWebConsumer_1 = require("../../../../client/BaseGrpcWebConsumer");
const core_proto_ts_1 = require("@injectivelabs/core-proto-ts");
class TxGrpcApi {
    constructor(endpoint) {
        this.endpoint = endpoint;
        this.txService = new core_proto_ts_1.CosmosTxV1Beta1Service.ServiceClientImpl((0, BaseGrpcWebConsumer_1.getGrpcWebImpl)(endpoint));
    }
    fetchTx(hash) {
    ...
    broadcast(txRaw, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { mode, timeout } = options || {
                mode: core_proto_ts_1.CosmosTxV1Beta1Service.BroadcastMode.BROADCAST_MODE_SYNC,
