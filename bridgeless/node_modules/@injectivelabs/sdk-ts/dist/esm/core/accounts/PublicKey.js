...
import { publicKey as EthCryptoPublicKey, util as EthCryptoUtil, } from 'eth-crypto';
...
export class PublicKey {
    ...
    toAddress() {
        ...
        const addressBuffer = Buffer.from(keccak256(toBuffer(EthCryptoUtil.addLeading0x(decompressedPublicKey))), 'hex').subarray(-20);
