import { TransactionException, GrpcUnaryRequestException, } from '@injectivelabs/exceptions';
import { DEFAULT_TX_BLOCK_INCLUSION_TIMEOUT_IN_MS, DEFAULT_BLOCK_TIME_IN_SECONDS, } from '@injectivelabs/utils';
...
export class TxGrpcApi {
    ...
    constructor(endpoint) {
        ...
        this.txService = new CosmosTxV1Beta1Service.ServiceClientImpl(getGrpcWebImpl(endpoint));
    }
    async fetchTx(hash) {
