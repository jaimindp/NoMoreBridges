...
export declare const usdcContract: (<K1 extends "Mainnet" | "Testnet", K2 extends keyof {
    readonly Mainnet: {
...
export declare const circleChainId: (<K1 extends "Mainnet" | "Testnet", K2 extends keyof {
    ...
    get: (args_0: string, args_1: string) => 1 | 5 | 7 | undefined;
    has: (args_0: string, args_1: string) => boolean;
};
export declare const circleChainIdToChain: (<K1 extends "Mainnet" | "Testnet", K2 extends keyof {
    Mainnet: {
        0: "Ethereum";
        1: "Avalanche";
        2: "Optimism";
    ...
    get: (args_0: string, args_1: number) => "Solana" | "Ethereum" | "Polygon" | "Avalanche" | "Arbitrum" | "Optimism" | "Base" | "Sepolia" | "ArbitrumSepolia" | "BaseSepolia" | "OptimismSepolia" | undefined;
    has: (args_0: string, args_1: number) => boolean;
};
