...
function deserializeLayout(layout, bytes, opts) {
    const encoded = {
        bytes,
...
function deserializeNum(encoded, size, endianness = "big", signed = false) {
    let val = 0n;
    ...
    return ((size > layout_1.numberMaxSize) ? val : Number(val));
}
function deserializeLayoutItem(item, encoded) {
    switch (item.binary) {
        ...
        case "uint": {
            ...
            const { custom } = item;
            if ((0, utils_1.isNumType)(custom)) {
                (0, utils_1.checkNumEquals)(custom, value);
                return custom;
            }
            if ((0, utils_1.isNumType)(custom?.from)) {
                (0, utils_1.checkNumEquals)(custom.from, value);
                return custom.to;
            }
        ...
        case "bytes": {
            ...
            if ("layout" in item) { //handle layout conversions
                ...
                if (custom !== undefined) {
                    if (typeof custom.from !== "function") {
                        (0, utils_1.checkBytesTypeEqual)((0, serialize_1.getCachedSerializedFrom)(item), encoded.bytes, { dataSlize: [offset, encoded.offset] });
                        return custom.to;
                    }
            ...
            { //handle fixed conversions
                ...
                if (fixedFrom !== undefined) {
                    ...
                    (0, utils_1.checkBytesTypeEqual)(fixedFrom, value);
                    updateOffset(encoded, size);
