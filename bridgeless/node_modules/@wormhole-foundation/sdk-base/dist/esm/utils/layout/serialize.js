...
import { checkItemSize, checkBytesTypeEqual, checkNumEquals, findIdLayoutPair, isFixedBytesConversion, isLayoutItem, isNumType, isBytesType, } from "./utils";
...
export function serializeNum(val, size, cursor, endianness = "big", signed = false) {
    if (!signed && val < 0)
