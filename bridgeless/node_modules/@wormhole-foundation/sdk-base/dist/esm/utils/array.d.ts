...
type ExcludeIndexesImpl<T extends RoArray, C extends number> = T extends readonly [infer Head, ...infer Tail] ? Head extends readonly [infer V, infer I extends number] ? I extends C ? ExcludeIndexesImpl<Tail, C> : [V, ...ExcludeIndexesImpl<Tail, C>] : never : [];
