...
exports.AutomaticTokenTransfer = void 0;
const sdk_definitions_1 = require("@wormhole-foundation/sdk-definitions");
const common_1 = require("../../common");
const types_1 = require("../../types");
const tokenTransfer_1 = require("./tokenTransfer");
const utils_1 = require("./utils");
class AutomaticTokenTransfer extends tokenTransfer_1.TokenTransfer {
    getTransferState() {
    ...
    async completeTransfer(signer) {
        ...
        const destinationTxs = await AutomaticTokenTransfer.redeem(this.toChain, vaa, signer);
        this.receipt = {
            ...this.receipt,
    ...
    static async transfer(chainCtx, transfer, signer) {
        ...
        const xfer = tb.transfer(senderAddress, transfer.to, transfer.token.address, transfer.amount, transfer.nativeGas);
...
exports.AutomaticTokenTransfer = AutomaticTokenTransfer;
