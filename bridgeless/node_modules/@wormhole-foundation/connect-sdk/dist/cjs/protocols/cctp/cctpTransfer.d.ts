...
export declare class CircleTransfer<N extends Network = Network> implements WormholeTransfer<CircleTransferProtocol> {
    ...
    static transfer<N extends Network, C extends Chain = Chain>(fromChain: ChainContext<N, Platform, C>, transfer: CircleTransferDetails, signer: Signer<N, Chain>): Promise<TransactionId[]>;
    ...
    static getTransferMessage<N extends Network>(fromChain: ChainContext<N, Platform, Chain>, txid: TxHash): Promise<import("@wormhole-foundation/sdk-definitions").CircleTransferMessage>;
    static getReceipt<N extends Network>(xfer: CircleTransfer<N>): CircleTransferReceipt;
    static track<N extends Network, SC extends Chain, DC extends Chain>(wh: Wormhole<N>, receipt: CircleTransferReceipt<SC, DC>, timeout?: number, _fromChain?: ChainContext<N, ChainToPlatform<SC>, SC>, _toChain?: ChainContext<N, ChainToPlatform<DC>, DC>): AsyncGenerator<CircleTransferReceipt<SC, DC>>;
}
export {};
