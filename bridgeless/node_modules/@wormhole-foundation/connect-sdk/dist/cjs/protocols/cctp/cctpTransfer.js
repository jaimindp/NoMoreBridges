...
class CircleTransfer {
    ...
    static async fromCircleMessage(wh, message) {
        ...
        xfer._state = types_1.TransferState.SourceInitiated;
        return xfer;
    }
    ...
    static async fromTransaction(wh, from, timeout, fromChain) {
        ...
        ct._state = types_1.TransferState.SourceInitiated;
        ct.txids = [from];
        return ct;
    }
    ...
    static async transfer(fromChain, transfer, signer) {
        ...
        return await (0, common_1.signSendWait)(fromChain, xfer, signer);
    }
