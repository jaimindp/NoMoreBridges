...
(function (AccAddress) {
    ...
    function validate(data) {
        ...
        return (checkPrefixAndLength('xpla', data, 43) ||
    ...
    function fromValAddress(address) {
        ...
        return bech32_1.bech32.encode('xpla', vals.words);
    }
...
(function (AccPubKey) {
    ...
    function fromAccAddress(address) {
        var vals = bech32_1.bech32.decode(address);
        return bech32_1.bech32.encode('xplapub', vals.words);
    }
...
(function (ValAddress) {
    ...
    function fromAccAddress(address) {
        var vals = bech32_1.bech32.decode(address);
        return bech32_1.bech32.encode('xplavaloper', vals.words);
    }
...
(function (ValPubKey) {
    ...
    function fromValAddress(valAddress) {
        ...
        return bech32_1.bech32.encode('xplavaloperpub', vals.words);
    }
