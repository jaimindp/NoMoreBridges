...
var RawKey = /** @class */ (function (_super) {
    ...
    RawKey.prototype.ecdsaSign = function (payload) {
        ...
        var signature = signingKey.signDigest((0, keccak256_1.keccak256)(payload));
        return signature;
    };
    RawKey.prototype.sign = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var signature, splite;
            return __generator(this, function (_a) {
                signature = this.ecdsaSign(payload);
                splite = (0, bytes_1.splitSignature)(signature);
                return [2 /*return*/, Buffer.from((0, bytes_1.arrayify)((0, bytes_1.concat)([splite.r, splite.s])))];
            });
        });
    };
    return RawKey;
