...
export declare class OptimisticOracleV2 implements OracleInterface {
    ...
    fetchRequest({ requester, identifier, timestamp, ancillaryData }: RequestKey): Promise<Request>;
    parseLog: (log: Log) => {
        event: string;
