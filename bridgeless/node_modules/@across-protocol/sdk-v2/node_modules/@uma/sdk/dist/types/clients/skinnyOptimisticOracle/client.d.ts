import { SkinnyOptimisticOracleEthers } from "@uma/contracts-frontend";
import type { SignerOrProvider, GetEventType } from "../..";
import { Event, BigNumberish, utils, BigNumber } from "ethers";
export declare type Instance = SkinnyOptimisticOracleEthers;
...
export declare type Request = RequestKey & SolidityRequest & Partial<{
