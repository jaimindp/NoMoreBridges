 ...
 */
export declare function blockExplorerLink(txHashOrAddress: string, chainId: number | string): string;
/**
 ...
 */
export declare function resolveBlockExplorerDomain(networkId: number): string | undefined;
/**
 ...
 */
export declare function blockExplorerLinks(txHashesOrAddresses: string[], chainId: number | string): string;
//# sourceMappingURL=BlockExplorerUtils.d.ts.map