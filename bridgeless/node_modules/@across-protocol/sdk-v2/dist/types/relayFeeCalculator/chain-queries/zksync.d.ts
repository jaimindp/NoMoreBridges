...
export declare class ZkSyncQueries extends QueryBase {
 ...
 */
export declare class zkSyncGoerliQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
 ...
 */
export declare class zkSyncSepoliaQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
