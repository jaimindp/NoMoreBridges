...
export declare class OptimismQueries extends QueryBase {
 ...
 */
export declare class OptimismGoerliQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
...
export declare class OptimismSepoliaQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
