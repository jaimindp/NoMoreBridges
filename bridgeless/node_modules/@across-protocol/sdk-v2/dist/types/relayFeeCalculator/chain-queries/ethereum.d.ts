...
export declare class EthereumQueries extends QueryBase {
 ...
 */
export declare class EthereumGoerliQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
 ...
 */
export declare class EthereumSepoliaQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
