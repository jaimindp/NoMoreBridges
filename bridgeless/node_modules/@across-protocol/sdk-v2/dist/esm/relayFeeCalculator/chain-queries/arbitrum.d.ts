...
export declare class ArbitrumQueries extends QueryBase {
 ...
 */
export declare class ArbitrumGoerliQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
...
export declare class ArbitrumSepoliaQueries extends QueryBase {
    constructor(provider: providers.Provider, symbolMapping?: {
        ACX: {
            name: string;
            symbol: string;
