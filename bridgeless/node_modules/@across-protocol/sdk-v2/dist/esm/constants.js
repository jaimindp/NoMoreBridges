...
export var ZERO_ADDRESS = ethersConstants.AddressZero;
// 2^96 - 1 is a conservative erc20 max allowance.
export var MAX_SAFE_ALLOWANCE = "79228162514264337593543950335";
export var SECONDS_PER_YEAR = 31557600; // 365.25 days per year.
/**
 * This is the protocol default chain Id for the hub pool.
 */
export var HUBPOOL_CHAIN_ID = 1;
// List of versions where certain UMIP features were deprecated
export var TRANSFER_THRESHOLD_MAX_CONFIG_STORE_VERSION = 1;
// A hardcoded identifier used, by default, to tag all Arweave records.
export var ARWEAVE_TAG_APP_NAME = "across-protocol";
/**
 ...
 */
export var PROTOCOL_DEFAULT_CHAIN_ID_INDICES = [1, 10, 137, 288, 42161];
// See src/utils/NetworkUtils for helpers.
export var PRODUCTION_CHAIN_IDS = [
...
export var DEFAULT_BLOCKCHAIN_EXPLORER_DOMAIN = "https://etherscan.io";
export var DEFAULT_CACHING_TTL = 60 * 60 * 24 * 7 * 2; // 2 Weeks
export var DEFAULT_CACHING_SAFE_LAG = 60 * 60; // 1 hour
export var UBA_BOUNDS_RANGE_MAX = BigNumber.from(String(Number.MAX_SAFE_INTEGER)).mul(utils.parseEther("1.0"));
export var UBA_BOUNDS_RANGE_MIN = UBA_BOUNDS_RANGE_MAX.mul(-1);
export var DEFAULT_SIMULATED_RELAYER_ADDRESS = "0x428AB2BA90Eba0a4Be7aF34C9Ac451ab061AC010";
