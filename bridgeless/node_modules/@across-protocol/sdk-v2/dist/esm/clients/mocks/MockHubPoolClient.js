...
var MockHubPoolClient = /** @class */ (function (_super) {
    __extends(MockHubPoolClient, _super);
    function MockHubPoolClient(logger, hubPool, configStoreClient, deploymentBlock, chainId) {
        ...
        _this.l1TokensMock = []; // L1Tokens and their associated info.
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, _super.prototype.computeRealizedLpFeePct.call(this, deposit)];
                    case 2:
                        _b = _c.sent();
                        _c.label = 3;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, _super.prototype.batchComputeRealizedLpFeePct.call(this, _deposits)];
                    case 2:
                        _b = _c.sent();
                        _c.label = 3;
                    case 3: return [2 /*return*/, _b];
    ...
    MockHubPoolClient.prototype.setCrossChainContracts = function (chainId, contract, blockNumber) {
        ...
        assign(this.crossChainContracts, [chainId], [
            {
                spokePool: contract,
    ...
    MockHubPoolClient.prototype.proposeRootBundle = function (challengePeriodEndTimestamp, poolRebalanceLeafCount, bundleEvaluationBlockNumbers, poolRebalanceRoot, relayerRefundRoot, slowRelayRoot, proposer, overrides) {
        ...
        proposer !== null && proposer !== void 0 ? proposer : (proposer = randomAddress());
    ...
    MockHubPoolClient.prototype.executeRootBundle = function (groupIndex, leafId, chainId, l1Tokens, bundleLpFees, netSendAmounts, runningBalances, caller, overrides) {
        ...
        caller !== null && caller !== void 0 ? caller : (caller = randomAddress());
