...
export declare type WhitelistedTokensEvent = TypedEvent<[
    string,
    string
], WhitelistedTokensEventObject>;
export declare type WhitelistedTokensEventFilter = TypedEventFilter<WhitelistedTokensEvent>;
export interface Arbitrum_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _l2GatewayRouter: string, _crossDomainAdmin: string, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _l2GatewayRouter: string, _crossDomainAdmin: string, _hubPool: string, overrides?: CallOverrides): Promise<void>;
        l2GatewayRouter(overrides?: CallOverrides): Promise<string>;
