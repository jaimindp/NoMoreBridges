...
export declare namespace SpokePoolInterface {
    ...
    type SlowFillStruct = {
        relayData: SpokePoolInterface.RelayDataStruct;
        payoutAdjustmentPct: BigNumberish;
    };
    type SlowFillStructOutput = [
        SpokePoolInterface.RelayDataStructOutput,
        BigNumber
    ] & {
        relayData: SpokePoolInterface.RelayDataStructOutput;
...
export interface MerkleLibTestInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "verifySlowRelayFulfillment", values: [BytesLike, SpokePoolInterface.SlowFillStruct, BytesLike[]]): string;
...
export interface MerkleLibTest extends BaseContract {
    ...
    functions: {
        ...
        verifySlowRelayFulfillment(root: BytesLike, slowFill: SpokePoolInterface.SlowFillStruct, proof: BytesLike[], overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        verifySlowRelayFulfillment(root: BytesLike, slowFill: SpokePoolInterface.SlowFillStruct, proof: BytesLike[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        verifySlowRelayFulfillment(root: BytesLike, slowFill: SpokePoolInterface.SlowFillStruct, proof: BytesLike[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
