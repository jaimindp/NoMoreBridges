...
export interface Ethereum_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _hubPool: string, overrides?: CallOverrides): Promise<void>;
