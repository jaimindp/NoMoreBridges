...
export interface Linea_SpokePoolInterface extends utils.Interface {
    functions: {
        ...
        "depositForNow(address,address,address,uint256,uint256,int64,bytes,uint256)": FunctionFragment;
        "depositNow(address,address,uint256,uint256,int64,bytes,uint256)": FunctionFragment;
        ...
        "initialize(uint32,address,address,address,address,address)": FunctionFragment;
        "l2MessageService()": FunctionFragment;
        "l2TokenBridge()": FunctionFragment;
        "l2UsdcBridge()": FunctionFragment;
        ...
        "setL2UsdcBridge(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "MAX_TRANSFER_SIZE" | "SLOW_FILL_MAX_TOKENS_TO_SEND" | "UPDATE_DEPOSIT_DETAILS_HASH" | "UPDATE_V3_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "chainId" | "crossDomainAdmin" | "deposit" | "depositFor" | "depositForNow" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "emergencyDeleteRootBundle" | "enabledDepositRoutes" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "executeV3SlowRelayLeaf" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "fillV3RelayWithUpdatedDeposit" | "getCurrentTime" | "hubPool" | "initialize" | "l2MessageService" | "l2TokenBridge" | "l2UsdcBridge" | "minimumFeeInWei" | "multicall" | "numberOfDeposits" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "relayRootBundle" | "requestV3SlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setEnableRoute" | "setHubPool" | "setL2MessageService" | "setL2TokenBridge" | "setL2UsdcBridge" | "speedUpDeposit" | "speedUpV3Deposit" | "upgradeTo" | "upgradeToAndCall" | "wrappedNativeToken"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "depositForNow", values: [
        string,
        string,
        string,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: "l2UsdcBridge", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setL2UsdcBridge", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "depositForNow", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "l2UsdcBridge", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setL2UsdcBridge", data: BytesLike): Result;
    ...
    events: {
        ...
        "SetL2UsdcBridge(address,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "SetL2UsdcBridge"): EventFragment;
...
export declare type SetL2MessageServiceEvent = TypedEvent<[
    string,
    string
], SetL2MessageServiceEventObject>;
export declare type SetL2MessageServiceEventFilter = TypedEventFilter<SetL2MessageServiceEvent>;
...
export interface SetL2UsdcBridgeEventObject {
    newUsdcBridge: string;
    oldUsdcBridge: string;
}
export declare type SetL2UsdcBridgeEvent = TypedEvent<[
    string,
    string
], SetL2UsdcBridgeEventObject>;
export declare type SetL2UsdcBridgeEventFilter = TypedEventFilter<SetL2UsdcBridgeEvent>;
...
export interface Linea_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        depositForNow(depositor: string, recipient: string, originToken: string, amount: BigNumberish, destinationChainId: BigNumberish, relayerFeePct: BigNumberish, message: BytesLike, maxCount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        depositNow(recipient: string, originToken: string, amount: BigNumberish, destinationChainId: BigNumberish, relayerFeePct: BigNumberish, message: BytesLike, maxCount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        initialize(_initialDepositId: BigNumberish, _l2MessageService: string, _l2TokenBridge: string, _l2UsdcBridge: string, _crossDomainAdmin: string, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        l2MessageService(overrides?: CallOverrides): Promise<[string]>;
        l2TokenBridge(overrides?: CallOverrides): Promise<[string]>;
        l2UsdcBridge(overrides?: CallOverrides): Promise<[string]>;
        ...
        setL2UsdcBridge(_l2UsdcBridge: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        depositForNow(depositor: string, recipient: string, originToken: string, amount: BigNumberish, destinationChainId: BigNumberish, relayerFeePct: BigNumberish, message: BytesLike, maxCount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        depositNow(recipient: string, originToken: string, amount: BigNumberish, destinationChainId: BigNumberish, relayerFeePct: BigNumberish, message: BytesLike, maxCount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        depositQuoteTimeBuffer(overrides?: CallOverrides): Promise<number>;
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _l2MessageService: string, _l2TokenBridge: string, _l2UsdcBridge: string, _crossDomainAdmin: string, _hubPool: string, overrides?: CallOverrides): Promise<void>;
        l2MessageService(overrides?: CallOverrides): Promise<string>;
        l2TokenBridge(overrides?: CallOverrides): Promise<string>;
        l2UsdcBridge(overrides?: CallOverrides): Promise<string>;
        minimumFeeInWei(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setL2UsdcBridge(_l2UsdcBridge: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "SetL2UsdcBridge(address,address)"(newUsdcBridge?: string | null, oldUsdcBridge?: null): SetL2UsdcBridgeEventFilter;
        SetL2UsdcBridge(newUsdcBridge?: string | null, oldUsdcBridge?: null): SetL2UsdcBridgeEventFilter;
    ...
    estimateGas: {
        ...
        l2UsdcBridge(overrides?: CallOverrides): Promise<BigNumber>;
        minimumFeeInWei(overrides?: CallOverrides): Promise<BigNumber>;
        multicall(data: BytesLike[], overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        l2UsdcBridge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
