...
export declare type SetZkBridgeEvent = TypedEvent<[
    string,
    string
], SetZkBridgeEventObject>;
export declare type SetZkBridgeEventFilter = TypedEventFilter<SetZkBridgeEvent>;
...
export interface ZkSync_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _zkErc20Bridge: string, _crossDomainAdmin: string, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _zkErc20Bridge: string, _crossDomainAdmin: string, _hubPool: string, overrides?: CallOverrides): Promise<void>;
        l2Eth(overrides?: CallOverrides): Promise<string>;
