...
export declare type SetFxChildEvent = TypedEvent<[string], SetFxChildEventObject>;
export declare type SetFxChildEventFilter = TypedEventFilter<SetFxChildEvent>;
...
export declare type SetPolygonTokenBridgerEvent = TypedEvent<[
    string
], SetPolygonTokenBridgerEventObject>;
export declare type SetPolygonTokenBridgerEventFilter = TypedEventFilter<SetPolygonTokenBridgerEvent>;
...
export interface Polygon_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_initialDepositId: BigNumberish, _polygonTokenBridger: string, _crossDomainAdmin: string, _hubPool: string, _fxChild: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_initialDepositId: BigNumberish, _polygonTokenBridger: string, _crossDomainAdmin: string, _hubPool: string, _fxChild: string, overrides?: CallOverrides): Promise<void>;
