...
export declare type SetL2GatewayRouterEvent = TypedEvent<[
    string,
    string
], SetL2GatewayRouterEventObject>;
export declare type SetL2GatewayRouterEventFilter = TypedEventFilter<SetL2GatewayRouterEvent>;
export interface SetL2ScrollMessengerEventObject {
    newScrollMessenger: string;
    oldScrollMessenger: string;
}
export declare type SetL2ScrollMessengerEvent = TypedEvent<[
    string,
    string
], SetL2ScrollMessengerEventObject>;
export declare type SetL2ScrollMessengerEventFilter = TypedEventFilter<SetL2ScrollMessengerEvent>;
...
export interface Scroll_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_l2GatewayRouter: string, _l2ScrollMessenger: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_l2GatewayRouter: string, _l2ScrollMessenger: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _hubPool: string, overrides?: CallOverrides): Promise<void>;
        l2GatewayRouter(overrides?: CallOverrides): Promise<string>;
        l2ScrollMessenger(overrides?: CallOverrides): Promise<string>;
