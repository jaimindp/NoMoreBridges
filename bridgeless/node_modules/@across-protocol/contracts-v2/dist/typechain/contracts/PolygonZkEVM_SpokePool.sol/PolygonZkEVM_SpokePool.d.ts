...
export interface PolygonZkEVM_SpokePoolInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "EMPTY_RELAYER" | "EMPTY_REPAYMENT_CHAIN_ID" | "INFINITE_FILL_DEADLINE" | "MAX_TRANSFER_SIZE" | "POLYGON_ZKEVM_L1_NETWORK_ID" | "SLOW_FILL_MAX_TOKENS_TO_SEND" | "UPDATE_DEPOSIT_DETAILS_HASH" | "UPDATE_V3_DEPOSIT_DETAILS_HASH" | "__SpokePool_init" | "chainId" | "crossDomainAdmin" | "deposit" | "depositFor" | "depositForNow" | "depositNow" | "depositQuoteTimeBuffer" | "depositV3" | "emergencyDeleteRootBundle" | "enabledDepositRoutes" | "executeRelayerRefundLeaf" | "executeSlowRelayLeaf" | "executeV3SlowRelayLeaf" | "fillDeadlineBuffer" | "fillRelay" | "fillRelayWithUpdatedDeposit" | "fillStatuses" | "fillV3Relay" | "fillV3RelayWithUpdatedDeposit" | "getCurrentTime" | "hubPool" | "initialize" | "l2PolygonZkEVMBridge" | "multicall" | "numberOfDeposits" | "onMessageReceived" | "pauseDeposits" | "pauseFills" | "pausedDeposits" | "pausedFills" | "proxiableUUID" | "relayRootBundle" | "requestV3SlowFill" | "rootBundles" | "setCrossDomainAdmin" | "setEnableRoute" | "setHubPool" | "setL2PolygonZkEVMBridge" | "speedUpDeposit" | "speedUpV3Deposit" | "upgradeTo" | "upgradeToAndCall" | "wrappedNativeToken"): FunctionFragment;
...
export declare type SetPolygonZkEVMBridgeEvent = TypedEvent<[
    string,
    string
], SetPolygonZkEVMBridgeEventObject>;
export declare type SetPolygonZkEVMBridgeEventFilter = TypedEventFilter<SetPolygonZkEVMBridgeEvent>;
...
export interface PolygonZkEVM_SpokePool extends BaseContract {
    ...
    functions: {
        ...
        initialize(_l2PolygonZkEVMBridge: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _hubPool: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getCurrentTime(overrides?: CallOverrides): Promise<BigNumber>;
        hubPool(overrides?: CallOverrides): Promise<string>;
        initialize(_l2PolygonZkEVMBridge: string, _initialDepositId: BigNumberish, _crossDomainAdmin: string, _hubPool: string, overrides?: CallOverrides): Promise<void>;
        l2PolygonZkEVMBridge(overrides?: CallOverrides): Promise<string>;
