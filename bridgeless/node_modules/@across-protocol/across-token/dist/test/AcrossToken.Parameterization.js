...
describe("AcrossToken: Parameterization", async function () {
    beforeEach(async function () {
        ...
        ({ acrossToken } = await (0, AcceleratingDistributor_Fixture_1.acceleratingDistributorFixture)());
    });
    ...
    it("Token mint permissions works as expected set correctly", async function () {
        ...
        await (0, utils_1.expect)(() => acrossToken.mint(owner.address, (0, utils_1.toWei)(69))).to.changeTokenBalance(acrossToken, owner, (0, utils_1.toWei)(69));
        await (0, utils_1.expect)(() => acrossToken.burn(owner.address, (0, utils_1.toWei)(4))).to.changeTokenBalance(acrossToken, owner, (0, utils_1.toWei)(-4));
