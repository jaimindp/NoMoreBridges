...
export declare function getBridgeAdminAddress(chainId: number): string;
export declare function getWETH_BridgePoolAddress(chainId: number): string;
export declare function getUSDC_BridgePoolAddress(chainId: number): string;
export declare function getUMA_BridgePoolAddress(chainId: number): string;
export declare function getBADGER_BridgePoolAddress(chainId: number): string;
export declare function getWBTC_BridgePoolAddress(chainId: number): string;
export declare function getArbitrum_MessengerAddress(chainId: number): string;
export declare function getOptimism_MessengerAddress(chainId: number): string;
export declare function getOptimism_WrapperAddress(chainId: number): string;
export declare function getRateModelStoreAddress(chainId: number): string;
export declare function getOVM_OETH_BridgeDepositBoxAddress(chainId: number): string;
export declare function getAVM_BridgeDepositBoxAddress(chainId: number): string;
export declare function getFinderAddress(chainId: number): string;
export declare function getVotingTokenAddress(chainId: number): string;
export declare function getIdentifierWhitelistAddress(chainId: number): string;
export declare function getVotingAddress(chainId: number): string;
export declare function getRegistryAddress(chainId: number): string;
export declare function getFinancialContractsAdminAddress(chainId: number): string;
export declare function getStoreAddress(chainId: number): string;
export declare function getGovernorAddress(chainId: number): string;
export declare function getDesignatedVotingFactoryAddress(chainId: number): string;
export declare function getDesignatedVotingV2FactoryAddress(chainId: number): string;
export declare function getWETH9Address(chainId: number): string;
export declare function getTokenFactoryAddress(chainId: number): string;
export declare function getAddressWhitelistAddress(chainId: number): string;
export declare function getExpiringMultiPartyLibAddress(chainId: number): string;
export declare function getExpiringMultiPartyCreatorAddress(chainId: number): string;
export declare function getOptimisticOracleAddress(chainId: number): string;
export declare function getOptimisticOracleV2Address(chainId: number): string;
export declare function getPerpetualLibAddress(chainId: number): string;
export declare function getPerpetualCreatorAddress(chainId: number): string;
export declare function getDSProxyFactoryAddress(chainId: number): string;
export declare function getDSGuardFactoryAddress(chainId: number): string;
export declare function getMockOracleAncillaryAddress(chainId: number): string;
export declare function getOracleRootTunnelAddress(chainId: number): string;
export declare function getGovernorRootTunnelAddress(chainId: number): string;
export declare function getLongShortPairCreatorAddress(chainId: number): string;
export declare function getBinaryOptionLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getCoveredCallLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getLinearLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getRangeBondLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getCappedYieldDollarLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getSimpleSuccessTokenLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getSuccessTokenLongShortPairFinancialProductLibraryAddress(chainId: number): string;
export declare function getSkinnyOptimisticOracleAddress(chainId: number): string;
export declare function getArbitrum_ParentMessengerAddress(chainId: number): string;
export declare function getOracleHubAddress(chainId: number): string;
export declare function getGovernorHubAddress(chainId: number): string;
export declare function getMulticall2Address(chainId: number): string;
export declare function getBoba_ParentMessengerAddress(chainId: number): string;
export declare function getOptimism_ParentMessengerAddress(chainId: number): string;
export declare function getProposerAddress(chainId: number): string;
export declare function getOptimisticOracleV3Address(chainId: number): string;
export declare function getFixedSlashSlashingLibraryAddress(chainId: number): string;
export declare function getVotingV2Address(chainId: number): string;
export declare function getGovernorV2Address(chainId: number): string;
export declare function getProposerV2Address(chainId: number): string;
export declare function getEmergencyProposerAddress(chainId: number): string;
export declare function getVotingUpgraderV2Address(chainId: number): string;
export declare function getOptimisticGovernorAddress(chainId: number): string;
export declare function getOriginValidatorAddress(chainId: number): string;
export declare function getOracleSpokeAddress(chainId: number): string;
export declare function getGovernorSpokeAddress(chainId: number): string;
export declare function getOptimism_ChildMessengerAddress(chainId: number): string;
export declare function getAdmin_ChildMessengerAddress(chainId: number): string;
export declare function getOracleChildTunnelAddress(chainId: number): string;
export declare function getGovernorChildTunnelAddress(chainId: number): string;
export declare function getMulticall3Address(chainId: number): string;
export declare function getBoba_ChildMessengerAddress(chainId: number): string;
export declare function getBridgeAddress(chainId: number): string;
export declare function getGenericHandlerAddress(chainId: number): string;
export declare function getTestnetERC20Address(chainId: number): string;
export declare function getArbitrum_ChildMessengerAddress(chainId: number): string;
export declare function getPolygon_ParentMessengerAddress(chainId: number): string;
export declare function getSkinnyOptimisticOracleV2Address(chainId: number): string;
export declare function getPolygon_ChildMessengerAddress(chainId: number): string;
export declare function getContractNames(): string[];
