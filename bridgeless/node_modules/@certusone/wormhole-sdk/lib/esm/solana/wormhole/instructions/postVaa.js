...
export function createPostVaaInstruction(wormholeProgramId, payer, vaa, signatureSet) {
    ...
    const methods = createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.postVaa(parsed.version, parsed.guardianSetIndex, parsed.timestamp, parsed.nonce, parsed.emitterChain, [...parsed.emitterAddress], new BN(parsed.sequence.toString()), parsed.consistencyLevel, parsed.payload);
    // @ts-ignore
