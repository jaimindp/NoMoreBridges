...
export interface QueryDemoInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "QT_ETH_CALL" | "QT_ETH_CALL_BY_TIMESTAMP" | "QT_ETH_CALL_WITH_FINALITY" | "QT_MAX" | "QT_SOL_ACCOUNT" | "VERSION" | "getMyCounter" | "getResponseDigest" | "getResponseHash" | "getState" | "parseAndVerifyQueryResponse" | "parseEthCallByTimestampQueryResponse" | "parseEthCallQueryResponse" | "parseEthCallWithFinalityQueryResponse" | "parseSolanaAccountQueryResponse" | "responsePrefix" | "updateCounters" | "updateRegistration" | "validateBlockNum" | "validateBlockTime" | "validateChainId" | "validateEthCallData" | "validateMultipleEthCallData" | "verifyQueryResponseSignatures" | "wormhole"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getMyCounter", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "updateCounters", values: [PromiseOrValue<BytesLike>, IWormhole.SignatureStruct[]]): string;
    encodeFunctionData(functionFragment: "updateRegistration", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "getMyCounter", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateCounters", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "updateRegistration", data: BytesLike): Result;
...
export interface QueryDemo extends BaseContract {
    ...
    functions: {
        ...
        getState(overrides?: CallOverrides): Promise<[QueryDemo.ChainEntryStructOutput[]]>;
        ...
        updateCounters(response: PromiseOrValue<BytesLike>, signatures: IWormhole.SignatureStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateRegistration(_chainID: PromiseOrValue<BigNumberish>, _contractAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        parseSolanaAccountQueryResponse(pcr: ParsedPerChainQueryResponseStruct, overrides?: CallOverrides): Promise<SolanaAccountQueryResponseStructOutput>;
        responsePrefix(overrides?: CallOverrides): Promise<string>;
        updateCounters(response: PromiseOrValue<BytesLike>, signatures: IWormhole.SignatureStruct[], overrides?: CallOverrides): Promise<void>;
        updateRegistration(_chainID: PromiseOrValue<BigNumberish>, _contractAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        validateBlockNum(_blockNum: PromiseOrValue<BigNumberish>, _minBlockNum: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        validateBlockTime(_blockTime: PromiseOrValue<BigNumberish>, _minBlockTime: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        validateChainId(chainId: PromiseOrValue<BigNumberish>, _validChainIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        validateEthCallData(r: EthCallDataStruct, _expectedContractAddresses: PromiseOrValue<string>[], _expectedFunctionSignatures: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>;
