...
export interface MockRelayerIntegrationInterface extends utils.Interface {
    functions: {
        "deliverReentrant(bytes)": FunctionFragment;
        ...
        "sendMessageWithReentrantDelivery(uint16,uint32,uint128)": FunctionFragment;
        "sendMessageWithRefund(bytes,uint16,uint32,uint128,uint16,address)": FunctionFragment;
        "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])": FunctionFragment;
        "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint16,bytes32,uint64)[])": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "deliverReentrant" | "emitterAddress" | "encodeMessage" | "getDeliveryData" | "getMessage" | "getMessageHistory" | "getRegisteredContract" | "getRegisteredContractAddress" | "receiveWormholeMessages" | "registerEmitter" | "registerEmitters" | "resend" | "sendMessage" | "sendMessageWithAdditionalVaas" | "sendMessageWithForwardedResponse(bytes,bytes,uint16,uint32,uint128)" | "sendMessageWithForwardedResponse(bytes,bytes,uint16,uint32,uint128,uint16,address)" | "sendMessageWithMultiForwardedResponse" | "sendMessageWithReentrantDelivery" | "sendMessageWithRefund" | "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])" | "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint16,bytes32,uint64)[])"): FunctionFragment;
    encodeFunctionData(functionFragment: "deliverReentrant", values: [PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "sendMessageWithReentrantDelivery", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
    ...
    encodeFunctionData(functionFragment: "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint16,bytes32,uint64)[])", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
    ...
    decodeFunctionResult(functionFragment: "deliverReentrant", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "sendMessageWithReentrantDelivery", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sendMessageWithRefund", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint16,bytes32,uint64)[])", data: BytesLike): Result;
    events: {};
}
export interface MockRelayerIntegration extends BaseContract {
    ...
    functions: {
        deliverReentrant(_deliveryVaa: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
        ...
        sendMessageWithReentrantDelivery(targetChain: PromiseOrValue<BigNumberish>, gasLimit: PromiseOrValue<BigNumberish>, receiverValue: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])"(targetChain: PromiseOrValue<BigNumberish>, destination: PromiseOrValue<string>, gasLimit: PromiseOrValue<BigNumberish>, refundChain: PromiseOrValue<BigNumberish>, refundAddress: PromiseOrValue<string>, receiverValue: PromiseOrValue<BigNumberish>, paymentForExtraReceiverValue: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, messageKeys: MessageKeyStruct[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint16,bytes32,uint64)[])"(targetChain: PromiseOrValue<BigNumberish>, destination: PromiseOrValue<string>, gasLimit: PromiseOrValue<BigNumberish>, refundChain: PromiseOrValue<BigNumberish>, refundAddress: PromiseOrValue<string>, receiverValue: PromiseOrValue<BigNumberish>, paymentForExtraReceiverValue: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, vaaKeys: VaaKeyStruct[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    deliverReentrant(_deliveryVaa: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
    ...
    callStatic: {
        deliverReentrant(_deliveryVaa: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        emitterAddress(overrides?: CallOverrides): Promise<string>;
        encodeMessage(message: MockRelayerIntegration.MessageStruct, overrides?: CallOverrides): Promise<string>;
        getDeliveryData(overrides?: CallOverrides): Promise<DeliveryDataStructOutput>;
        getMessage(overrides?: CallOverrides): Promise<string>;
        ...
        sendMessageWithReentrantDelivery(targetChain: PromiseOrValue<BigNumberish>, gasLimit: PromiseOrValue<BigNumberish>, receiverValue: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        "sendToEvm(uint16,address,uint32,uint16,address,uint128,uint256,bytes,(uint8,bytes)[])"(targetChain: PromiseOrValue<BigNumberish>, destination: PromiseOrValue<string>, gasLimit: PromiseOrValue<BigNumberish>, refundChain: PromiseOrValue<BigNumberish>, refundAddress: PromiseOrValue<string>, receiverValue: PromiseOrValue<BigNumberish>, paymentForExtraReceiverValue: PromiseOrValue<BigNumberish>, payload: PromiseOrValue<BytesLike>, messageKeys: MessageKeyStruct[], overrides?: CallOverrides): Promise<BigNumber>;
