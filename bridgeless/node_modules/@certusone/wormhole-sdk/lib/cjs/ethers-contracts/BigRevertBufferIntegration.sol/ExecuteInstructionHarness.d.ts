...
export declare namespace WormholeRelayerDelivery {
    type DeliveryResultsStruct = {
        gasUsed: PromiseOrValue<BigNumberish>;
        status: PromiseOrValue<BigNumberish>;
        additionalStatusInfo: PromiseOrValue<BytesLike>;
    };
    type DeliveryResultsStructOutput = [BigNumber, number, string] & {
        gasUsed: BigNumber;
        status: number;
        additionalStatusInfo: string;
    };
}
export interface ExecuteInstructionHarnessInterface extends utils.Interface {
    functions: {
        ...
        "executeInstruction_harness((uint16,bytes32,bytes,uint256,uint256,uint256,bytes32,bytes32,bytes[]))": FunctionFragment;
        "getRegisteredWormholeRelayerContract(uint16)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "deliver" | "deliveryAttempted" | "deliveryFailureBlock" | "deliverySuccessBlock" | "executeInstruction_harness" | "getRegisteredWormholeRelayerContract"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "executeInstruction_harness", values: [EvmDeliveryInstructionStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "executeInstruction_harness", data: BytesLike): Result;
...
export interface ExecuteInstructionHarness extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExecuteInstructionHarnessInterface;
    ...
    functions: {
        ...
        executeInstruction_harness(instruction: EvmDeliveryInstructionStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deliveryFailureBlock(deliveryHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        deliverySuccessBlock(deliveryHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        executeInstruction_harness(instruction: EvmDeliveryInstructionStruct, overrides?: CallOverrides): Promise<WormholeRelayerDelivery.DeliveryResultsStructOutput>;
        getRegisteredWormholeRelayerContract(chainId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
