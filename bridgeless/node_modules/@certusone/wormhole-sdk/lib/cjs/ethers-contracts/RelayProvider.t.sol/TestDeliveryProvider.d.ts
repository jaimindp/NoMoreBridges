...
export interface TestDeliveryProviderInterface extends utils.Interface {
    functions: {
        ...
        "testIsMessageKeyTypeSupported(uint8)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "testIsMessageKeyTypeSupported", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "testIsMessageKeyTypeSupported", data: BytesLike): Result;
...
export interface TestDeliveryProvider extends BaseContract {
    ...
    functions: {
        ...
        testIsMessageKeyTypeSupported(keyType: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        testIsMessageKeyTypeSupported(keyType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
