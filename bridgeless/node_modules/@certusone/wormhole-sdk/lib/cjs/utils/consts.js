 ...
 */
exports.SolanaChainNames = ["solana", "pythnet"];
exports.CosmWasmChainNames = [
    "terra",
    "terra2",
    "injective",
    "xpla",
...
exports.TerraChainNames = ["terra", "terra2"];
const MAINNET = {
    unset: {
        core: undefined,
 ...
 */
const isTestnetContracts = TESTNET;
/**
 *
 * See [[isTestnetContracts]]
 */
const isMainnetContracts = MAINNET;
/**
 *
 * See [[isTestnetContracts]]
 */
const isDevnetContracts = DEVNET;
/**
 *
 * Contracts addresses on testnet and mainnet
 */
exports.CONTRACTS = { MAINNET, TESTNET, DEVNET };
...
exports.CHAIN_ID_GATEWAY = exports.CHAIN_ID_WORMCHAIN;
...
function isEVMChain(chain) {
    ...
    return exports.EVMChainNames.includes(chainName);
}
exports.isEVMChain = isEVMChain;
function isCosmWasmChain(chain) {
    const chainName = coalesceChainName(chain);
    return exports.CosmWasmChainNames.includes(chainName);
}
exports.isCosmWasmChain = isCosmWasmChain;
function isTerraChain(chain) {
    const chainName = coalesceChainName(chain);
    return exports.TerraChainNames.includes(chainName);
}
exports.isTerraChain = isTerraChain;
function isSolanaChain(chain) {
    const chainName = coalesceChainName(chain);
    return exports.SolanaChainNames.includes(chainName);
}
