export declare const CHAINS: {
    ...
    readonly neutron: 4003;
    readonly celestia: 4004;
    readonly stargaze: 4005;
    readonly seda: 4006;
    readonly dymension: 4007;
 ...
 */
export declare const EVMChainNames: readonly ["ethereum", "bsc", "polygon", "avalanche", "oasis", "aurora", "fantom", "karura", "acala", "klaytn", "celo", "moonbeam", "neon", "arbitrum", "optimism", "gnosis", "base", "rootstock", "scroll", "mantle", "sepolia", "arbitrum_sepolia", "base_sepolia", "optimism_sepolia", "holesky"];
...
export declare const CosmWasmChainNames: readonly ["terra", "terra2", "injective", "xpla", "sei", "wormchain", "osmosis", "evmos", "cosmoshub", "kujira", "neutron", "celestia", "stargaze", "seda", "dymension"];
...
export declare const CHAIN_ID_SCROLL: 34;
export declare const CHAIN_ID_MANTLE: 35;
...
export declare const CHAIN_ID_NEUTRON: 4003;
export declare const CHAIN_ID_CELESTIA: 4004;
export declare const CHAIN_ID_STARGAZE: 4005;
export declare const CHAIN_ID_SEDA: 4006;
export declare const CHAIN_ID_DYMENSION: 4007;
export declare const CHAIN_ID_SEPOLIA: 10002;
export declare const CHAIN_ID_ARBITRUM_SEPOLIA: 10003;
export declare const CHAIN_ID_BASE_SEPOLIA: 10004;
export declare const CHAIN_ID_OPTIMISM_SEPOLIA: 10005;
export declare const CHAIN_ID_HOLESKY: 10006;
