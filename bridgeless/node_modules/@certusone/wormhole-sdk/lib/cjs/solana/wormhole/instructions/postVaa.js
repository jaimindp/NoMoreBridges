...
function createPostVaaInstruction(wormholeProgramId, payer, vaa, signatureSet) {
    const parsed = vaa_1.isBytes(vaa) ? vaa_1.parseVaa(vaa) : vaa;
    const methods = program_1.createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.postVaa(parsed.version, parsed.guardianSetIndex, parsed.timestamp, parsed.nonce, parsed.emitterChain, [...parsed.emitterAddress], new bn_js_1.default(parsed.sequence.toString()), parsed.consistencyLevel, parsed.payload);
    // @ts-ignore
