...
class WormholeInstructionCoder {
    ...
    static parseIxLayout(idl) {
        ...
        const ixLayouts = stateMethods
            ...
            const name = lodash_1.camelCase(m.name);
            ...
            const name = lodash_1.camelCase(ix.name);
            return [name, borsh.struct(fieldLayouts, name)];
        }));
    ...
    encode(ixName, ix) {
        ...
        const methodName = lodash_1.camelCase(ixName);
    ...
    decode(ix, encoding = "hex") {
        ...
        let data = ix.slice(1);
        let name = lodash_1.camelCase(WormholeInstruction[discriminator]);
