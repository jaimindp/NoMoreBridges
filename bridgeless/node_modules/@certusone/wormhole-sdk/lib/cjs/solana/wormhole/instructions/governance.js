...
function createSetFeesInstruction(wormholeProgramId, payer, vaa) {
    const methods = program_1.createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.setFees();
    // @ts-ignore
...
function getSetFeesAccounts(wormholeProgramId, payer, vaa) {
    const parsed = vaa_1.isBytes(vaa) ? vaa_1.parseGovernanceVaa(vaa) : vaa;
    return {
...
function createTransferFeesInstruction(wormholeProgramId, payer, recipient, vaa) {
    const methods = program_1.createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.transferFees();
    // @ts-ignore
    return methods._ixFn(...methods._args, {
...
function createUpgradeGuardianSetInstruction(wormholeProgramId, payer, vaa) {
    const methods = program_1.createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.upgradeGuardianSet();
    // @ts-ignore
    return methods._ixFn(...methods._args, {
...
function createUpgradeContractInstruction(wormholeProgramId, payer, vaa) {
    const methods = program_1.createReadOnlyWormholeProgramInterface(wormholeProgramId).methods.upgradeContract();
    // @ts-ignore
    return methods._ixFn(...methods._args, {
