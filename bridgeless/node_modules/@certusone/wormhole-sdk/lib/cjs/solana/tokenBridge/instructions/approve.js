...
function createApproveAuthoritySignerInstruction(tokenBridgeProgramId, tokenAccount, owner, amount) {
    return spl_token_1.createApproveInstruction(new web3_js_1.PublicKey(tokenAccount), accounts_1.deriveAuthoritySignerKey(tokenBridgeProgramId), new web3_js_1.PublicKey(owner), amount);
}
