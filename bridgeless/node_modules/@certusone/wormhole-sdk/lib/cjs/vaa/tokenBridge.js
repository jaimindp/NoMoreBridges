...
function parseTokenTransferVaa(vaa) {
    ...
    return Object.assign(Object.assign({}, parsed), parseTokenTransferPayload(parsed.payload));
}
...
function parseAttestMetaVaa(vaa) {
    const parsed = wormhole_1.parseVaa(vaa);
    return Object.assign(Object.assign({}, parsed), parseAttestMetaPayload(parsed.payload));
}
...
function parseTokenBridgeRegisterChainVaa(vaa) {
    ...
    return Object.assign(Object.assign({}, parsed), parseTokenBridgeRegisterChainGovernancePayload(parsed.orderPayload));
}
...
function parseTokenBridgeUpgradeContractVaa(vaa) {
    ...
    return Object.assign(Object.assign({}, parsed), parseTokenBridgeUpgradeContractGovernancePayload(parsed.orderPayload));
}
