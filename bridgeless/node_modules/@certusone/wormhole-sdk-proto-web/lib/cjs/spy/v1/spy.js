...
exports.GrpcWebImpl = exports.SpyRPCServiceSubscribeSignedVAAByTypeDesc = exports.SpyRPCServiceSubscribeSignedVAADesc = exports.SpyRPCServiceDesc = exports.SpyRPCServiceClientImpl = exports.SubscribeSignedVAAByTypeResponse = exports.SubscribeSignedVAAResponse = exports.SubscribeSignedVAAByTypeRequest = exports.SubscribeSignedVAARequest = exports.FilterEntry = exports.BatchTransactionFilter = exports.BatchFilter = exports.EmitterFilter = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.EmitterFilter = {
    ...
    fromJSON: function (object) {
        ...
        if (object.chainId !== undefined && object.chainId !== null) {
            message.chainId = (0, publicrpc_1.chainIDFromJSON)(object.chainId);
        }
        else {
            message.chainId = 0;
        }
    ...
    toJSON: function (message) {
        ...
        message.chainId !== undefined &&
            (obj.chainId = (0, publicrpc_1.chainIDToJSON)(message.chainId));
...
var baseBatchFilter = { chainId: 0, nonce: 0 };
exports.BatchFilter = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        if (message.chainId !== 0) {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseBatchFilter);
...
var baseBatchTransactionFilter = { chainId: 0 };
exports.BatchTransactionFilter = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        if (message.chainId !== 0) {
            writer.uint32(8).int32(message.chainId);
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseBatchTransactionFilter);
        message.txId = new Uint8Array();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
...
exports.FilterEntry = {
    encode: function (message, writer) {
        ...
        if (message.batchFilter !== undefined) {
            exports.BatchFilter.encode(message.batchFilter, writer.uint32(18).fork()).ldelim();
        }
        if (message.batchTransactionFilter !== undefined) {
            exports.BatchTransactionFilter.encode(message.batchTransactionFilter, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.batchFilter = exports.BatchFilter.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.batchTransactionFilter = exports.BatchTransactionFilter.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        ...
        if (object.batchFilter !== undefined && object.batchFilter !== null) {
            message.batchFilter = exports.BatchFilter.fromJSON(object.batchFilter);
        }
        else {
            message.batchFilter = undefined;
        }
        if (object.batchTransactionFilter !== undefined &&
            object.batchTransactionFilter !== null) {
            message.batchTransactionFilter = exports.BatchTransactionFilter.fromJSON(object.batchTransactionFilter);
        }
        else {
            message.batchTransactionFilter = undefined;
        }
        return message;
    },
    toJSON: function (message) {
        ...
        message.emitterFilter !== undefined &&
            (obj.emitterFilter = message.emitterFilter
                ...
                : undefined);
        message.batchFilter !== undefined &&
            (obj.batchFilter = message.batchFilter
                ? exports.BatchFilter.toJSON(message.batchFilter)
                : undefined);
        message.batchTransactionFilter !== undefined &&
            (obj.batchTransactionFilter = message.batchTransactionFilter
                ? exports.BatchTransactionFilter.toJSON(message.batchTransactionFilter)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        if (object.batchFilter !== undefined && object.batchFilter !== null) {
            message.batchFilter = exports.BatchFilter.fromPartial(object.batchFilter);
        }
        else {
            message.batchFilter = undefined;
        }
        if (object.batchTransactionFilter !== undefined &&
            object.batchTransactionFilter !== null) {
            message.batchTransactionFilter = exports.BatchTransactionFilter.fromPartial(object.batchTransactionFilter);
        }
        else {
            message.batchTransactionFilter = undefined;
        }
...
var baseSubscribeSignedVAAByTypeRequest = {};
exports.SubscribeSignedVAAByTypeRequest = {
    encode: function (message, writer) {
        var e_4, _a;
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseSubscribeSignedVAAByTypeRequest);
        message.filters = [];
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
...
var baseSubscribeSignedVAAByTypeResponse = {};
exports.SubscribeSignedVAAByTypeResponse = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        if (message.signedVaa !== undefined) {
            gossip_1.SignedVAAWithQuorum.encode(message.signedVaa, writer.uint32(10).fork()).ldelim();
        }
        if (message.signedBatchVaa !== undefined) {
            gossip_1.SignedBatchVAAWithQuorum.encode(message.signedBatchVaa, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseSubscribeSignedVAAByTypeResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.signedVaa = gossip_1.SignedVAAWithQuorum.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON: function (object) {
        var message = __assign({}, baseSubscribeSignedVAAByTypeResponse);
        if (object.signedVaa !== undefined && object.signedVaa !== null) {
            message.signedVaa = gossip_1.SignedVAAWithQuorum.fromJSON(object.signedVaa);
        }
        else {
            message.signedVaa = undefined;
        }
    ...
    toJSON: function (message) {
        var obj = {};
        message.signedVaa !== undefined &&
            (obj.signedVaa = message.signedVaa
                ? gossip_1.SignedVAAWithQuorum.toJSON(message.signedVaa)
                : undefined);
        message.signedBatchVaa !== undefined &&
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseSubscribeSignedVAAByTypeResponse);
        if (object.signedVaa !== undefined && object.signedVaa !== null) {
            message.signedVaa = gossip_1.SignedVAAWithQuorum.fromPartial(object.signedVaa);
        }
        else {
            message.signedVaa = undefined;
        }
...
var SpyRPCServiceClientImpl = /** @class */ (function () {
    function SpyRPCServiceClientImpl(rpc) {
        ...
        this.SubscribeSignedVAAByType = this.SubscribeSignedVAAByType.bind(this);
    }
    ...
    SpyRPCServiceClientImpl.prototype.SubscribeSignedVAAByType = function (request, metadata) {
        return this.rpc.invoke(exports.SpyRPCServiceSubscribeSignedVAAByTypeDesc, exports.SubscribeSignedVAAByTypeRequest.fromPartial(request), metadata);
    };
...
exports.SpyRPCServiceSubscribeSignedVAAByTypeDesc = {
    methodName: "SubscribeSignedVAAByType",
    service: exports.SpyRPCServiceDesc,
    requestStream: false,
    responseStream: true,
    requestType: {
        serializeBinary: function () {
            return exports.SubscribeSignedVAAByTypeRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary: function (data) {
            return __assign(__assign({}, exports.SubscribeSignedVAAByTypeResponse.decode(data)), { toObject: function () {
                    return this;
                } });
        },
    },
