...
export interface GossipMessage {
    ...
    signedQueryRequest: SignedQueryRequest | undefined;
    signedQueryResponse: SignedQueryResponse | undefined;
}
...
export interface SignedQueryRequest {
    ...
    queryRequest: Uint8Array;
    /** ECDSA signature using the requestor's public key. */
    signature: Uint8Array;
}
export interface SignedQueryResponse {
...
export declare const SignedQueryRequest: {
    encode(message: SignedQueryRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): SignedQueryRequest;
    fromJSON(object: any): SignedQueryRequest;
    toJSON(message: SignedQueryRequest): unknown;
    fromPartial(object: DeepPartial<SignedQueryRequest>): SignedQueryRequest;
};
export declare const SignedQueryResponse: {
    encode(message: SignedQueryResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): SignedQueryResponse;
    fromJSON(object: any): SignedQueryResponse;
    toJSON(message: SignedQueryResponse): unknown;
    fromPartial(object: DeepPartial<SignedQueryResponse>): SignedQueryResponse;
};
