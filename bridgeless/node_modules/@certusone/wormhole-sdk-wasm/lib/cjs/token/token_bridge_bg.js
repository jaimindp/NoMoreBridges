...
* @returns {any}
*/
function transfer_native_with_payload_ix(program_id, bridge_id, payer, message, from, mint, nonce, amount, target_address, target_chain, payload) {
    var ptr0 = passStringToWasm0(program_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(bridge_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
function transfer_wrapped_with_payload_ix(program_id, bridge_id, payer, message, from, from_owner, token_chain, token_address, nonce, amount, target_address, target_chain, payload) {
    var ptr0 = passStringToWasm0(program_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(bridge_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
