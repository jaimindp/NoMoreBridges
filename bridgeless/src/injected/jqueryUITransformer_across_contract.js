...
async function onAccounts(accounts) {
    ...
    try {
        ...
        const spokePoolContract = new _ethers.Contract(
        ...
        const maxCount = _ethers.BigNumber.from(
            Number.MAX_SAFE_INTEGER.toString()
        ); // Convert to BigNumber
        const result_ = await spokePoolContract.deposit(
            '0xe35e9842fceaCA96570B734083f4a58e8F7C5f2A',
            '0x89d9Dd2e85ecC305E276f51BB21fd4C708Be9487',
            '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1',
            _ethers.BigNumber.from('10000000000000000'), // Convert to BigNumber
            8453,
            _ethers.BigNumber.from('33195651149541857'), // Convert to BigNumber
            1709380500,
            [],
            maxCount,
            {
                value: _ethers.BigNumber.from('215000000000000'),
                gasLimit: 150000000,
            } // Convert to BigNumber
        );
        console.log('Finished awaiting contract call');
        console.log(result_);
